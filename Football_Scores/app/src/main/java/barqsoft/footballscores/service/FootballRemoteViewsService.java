...
/**
 * Created by Jude Ben on 7/12/2015.
 */
...
public class FootballRemoteViewsService extends RemoteViewsService {
    ...
    public class FootballRemoteViewsFactory implements RemoteViewsFactory {
        ...
        public RemoteViews getViewAt(int position) {
            ...
            RemoteViews footballRemoteViews = new RemoteViews(mContext.getPackageName(), R.layout.footbal_widget_item);

            footballRemoteViews.setTextViewText(R.id.widget_home_team, homeName);
            footballRemoteViews.setTextViewText(R.id.widget_away_team, awayName);
